...
function parseGraphNavMapImageMetadata(raw: string): GraphNavMapImageMetadata {
...
function parseGraphNavMetadata(raw: string): GraphNavMetadata {
  const value = JSON.parse(raw) as Record<string, unknown>;
  ...
  try {
    ...
    return {
      ...
      mapImageMetadataStreamName:
        value.mapImageMetadataStreamName || DEFAULT_CONFIG.mapImageMetadataStreamName,
      graphnavMetadataStreamName:
        value.graphnavMetadataStreamName || DEFAULT_CONFIG.graphnavMetadataStreamName,
      navStateStreamName: value.navStateStreamName || DEFAULT_CONFIG.navStateStreamName,
      gotoPoseCommandName:
        value.gotoPoseCommandName || DEFAULT_CONFIG.gotoPoseCommandName,
      pollIntervalMs:
